...
def monte_carlo(array,function,initial_guess,output=False):      # array has form [[value,uncertainty],[...],[...],...]
    ...
    if output==True:
        ...
        # plt.xlim(-20,20)
        # plt.savefig('/Users/Bryn_Lloyd/Documents/Uni/Year 3/Labs/Photoelectric Effect/Plots/monte-carlo_arrows.jpg',dpi=300)
...
def linear_fit(filename,positions,output=False):
    ...
    if output==True:
        ...
        plt.legend()
        sexy_plot()
        # plt.savefig('/Users/Bryn_Lloyd/Documents/Uni/Year 3/Labs/Photoelectric Effect/Plots/linear_fit_badexample2.jpg',dpi=300)
