'''
Data Analysis code for use on data taken during Hall Effect experiment.
Code calculates properties of the semiconductor devices such as resistivity, carrier densities, mobilities.
Code produces graphs to be saved locally for use in a presentation or lab report.
'''
